...
The site publishes an aggregated anonymous visitor statistics report at `/analytics_report.html`, generated by `log-analyzer` on production. No IPs or other personal information is stored.
