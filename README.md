...
The site publishes aggregated anonymous visitor statistics at `/analytics/report.html` and `/analytics/data/*.json`, generated by `log-analyzer` on production. No IPs or other personal information is stored.
