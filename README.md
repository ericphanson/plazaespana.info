...
The site archives aggregated anonymous visitor statistics [in repo](./log-analyzer-data), generated by `log-analyzer`. No IPs or other personal information is stored.
