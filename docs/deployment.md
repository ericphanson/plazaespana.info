...
- Publishes `/home/public/analytics-report.html`
...
- Checks `https://plazaespana.info/analytics-report.html` and enforces report `Generated:` age <= 3 days
...
/home/
  ...
  public/               # ✅ Web root (served via HTTP)
    ...
    analytics-report.html # Analytics report
...
- [ ] Verify public analytics report endpoint (`/analytics-report.html`)
